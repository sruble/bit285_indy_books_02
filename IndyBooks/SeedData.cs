...
namespace IndyBooks
{
    public static class SeedData
    {
        ...
        public static async Task Seed(IndyBooksDataContext context)
        {
            ...
            //  TODO: (1) Import NuGet Package "Bogus" fake data generator, then///DONE
            //  TODO: (do after each) Use "dotnet ef database drop", and run the application and inspect your data
            // // // tried above astep // got an unhandled exception//
            ...
            //Books/// drop database after each step of 1, 2, 3 
